SNAP-AI LAYER 1 — Clinical Text Pre-Processor (CTP) (v1.15)
...
============================================================
HISTORICAL vs CURRENT DIAGNOSIS FILTER (MANDATORY BINDING — v1.8)
...
- Its "ED" (Erstdiagnose) date or event date is BEFORE the current admission/operation date
...
- The diagnosis is listed as a standalone numbered item (not under "Postoperativ")
  and has a date preceding the current admission

MANDATORY DATE CHECK (v1.8 — CRITICAL):
...
BINDING EXAMPLE (Case 3 pattern — v1.8):
  ...
  Step 1: The PE has date 29.03.2023
  Step 2: Current operation is December 2023
  Step 3: March 2023 is 9 MONTHS BEFORE December 2023 → HISTORICAL
  Step 4: Output as: "HISTORICAL: Pulmonary embolism, paracentral left (March 2023),
           treated with Rivaroxaban. NOT a current postoperative complication."
  Step 5: Do NOT include in "DIAGNOSES WITH TREATMENTS"
  
  WRONG OUTPUT:
    "4. Pulmonary embolism, paracentral left (diagnosed on [DATE]).
     Therapy: anticoagulation with Rivaroxaban."
  → This is WRONG because it places a historical PE in DIAGNOSES WITH TREATMENTS,
    causing Layer 2 to extract it as a postoperative complication.
  
  CORRECT OUTPUT:
    "HISTORICAL: Pulmonary embolism, paracentral left (March 2023),
     under anticoagulation with Rivaroxaban."
  → Correctly labeled as HISTORICAL, kept separate from DIAGNOSES WITH TREATMENTS.
