SNAP-AI LAYER 1 — Clinical Text Pre-Processor (CTP) (v1.5)
...
CRITICAL — THERAPY LINES IN DIAGNOSIS LISTS:
When the diagnosis list includes explicit therapy/treatment details for a postoperative
complication (e.g. "Therapie: Urin-Dauerkatheter und Pradif-Therapie vom 23.10. - 28.10."),
you MUST preserve this information verbatim in clean_course_text.
...
Example of what MUST be preserved:
  "2. Postoperativ paralytischer Ileus ED 24.10.2023
   ...
   3. Postoperativer Harnverhalt, ED 23.10.2023
   Therapie: Urin-Dauerkatheter und Pradif-Therapie vom 23.10. - 28.10."

→ Include as: "Diagnoses list: Paralytic ileus (ED [DATE]), treated with nasogastric tube,
   Metoclopramid, Erythromycin. Urinary retention (ED [DATE]), treated with urinary catheter
   and Tamsulosin (Pradif) from [DATE] to [DATE]."
...
If postoperative complications are listed under "Diagnosen" with "Therapie:" lines,
include them clearly, e.g.:
"DIAGNOSES: Paralytic ileus (treated with NG tube, Metoclopramid, Erythromycin).
 Urinary retention (treated with catheter and Tamsulosin from [DATE] to [DATE])."
...
- No dropped "Therapie:" lines from the diagnosis list.
