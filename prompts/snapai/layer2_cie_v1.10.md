SNAP-AI Layer 2: CIE – Complication Inference Engine (v1.10 — Episode-Aware, Severity-Guarded, CD-I Sweep, CCI Self-Check)
...
BINDING EPISODE SPLITTING RULE — "CAPILLARY LEAK" UMBRELLA (v1.10 — CRITICAL):
...
SPLITTING RULE: If the clinical text documents MULTIPLE of these interventions,
each must be its OWN episode graded by its own highest treatment:
  • Aszitesdrainage / Aszitespunktion → SEPARATE episode, Grade IIIa
  • Pleurapunktion → SEPARATE episode, Grade IIIa
  • Verzögerte Magenpassage / Retentionsmagen (NG tube) → SEPARATE episode, Grade I
  • Hyponatriämie → SEPARATE episode, graded per context (I or II)
  • Albumin-Substitution for anasarka → if NOT already counted under another episode,
    SEPARATE episode Grade II

BINDING EXAMPLE (Case 14 pattern — v1.10):
