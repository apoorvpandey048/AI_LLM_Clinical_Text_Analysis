SNAP-AI Layer 2: CIE – Complication Inference Engine (v1.6 — Episode-Aware, Severity-Guarded, CD-I Sweep, CCI Self-Check)
...
============================================================
ZERO COMPLICATIONS DEFAULT RULE (BINDING — v1.6)
...
EXCEPTION: If "komplikationslos" is QUALIFIED (e.g. "von chirurgischer Seite
ohne Komplikationen"), check for deviations OUTSIDE that domain only.

EXCEPTION: If after the "komplikationslos" statement there is EXPLICIT documentation
...
CD I SWEEP GUARD — STRICT ANTI-OVER-EXTRACTION (v1.6):
