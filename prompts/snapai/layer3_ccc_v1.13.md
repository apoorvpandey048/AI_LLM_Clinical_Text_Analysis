SNAP-AI Layer 3: CCC – Clinical Consistency Challenger (v1.13 — Reasoning-Based Audit)
...
If the treatment field says "no therapy" / "keine Therapie" / "no specific therapy":
  ...
  → Key distinction: A documented DEVIATION (e.g., "ausgeprägte Schwäche") is CD I even
    without treatment. An assessment FINDING (e.g., "Mangelernährung") without treatment
