SNAP-AI Layer 3: CCC – Clinical Consistency Challenger (v1.4 — Full Episode Audit)
...
Multi-complication reference values (for verification):
[I] = 8.7
[II] = 20.9
[I, I] = 12.2
[I, II] = 22.6
...
If your grade combination matches a reference combination above, the CCI MUST match.
Flag any mismatch.
...
Erythrozytenkonzentrat), coagulation factors (Factor VII, PPSB, Konakion for coagulopathy),
Tamsulosin (Pradif), TPN (Smof Kabiven, Nutriflex, etc.),
therapeutic anticoagulation, prokinetics for ileus (Metoclopramid/Paspertin,
Erythromycin, Prostigmin), antipsychotics (Haloperidol, Quetiapin, Risperidon,
Olanzapin), Cordarone (Amiodarone), catecholamines/inotropes (Dobutamin,
Noradrenalin, Levosimendan).
...
• Prokinetics for ileus (e.g., Erythromycin, Paspertin) → Grade II
• Tamsulosin (Pradif) for urinary retention → Grade II
• Transfusion (Erythrozytenkonzentrat) → Grade II
• Albumin substitution → Grade II
• Haloperidol/Quetiapin for delirium → Grade II
• Cordarone for arrhythmia → Grade II
• Dobutamin for AV block → Grade II (NOT IV unless explicit organ failure)
...
RULE 3b — PUNCTURE/DRAINAGE = IIIa:
If Layer 2 graded a puncture or drainage procedure (Aszitesdrainage,
Pleurapunktion, CT/US-guided drainage) as less than IIIa, UPGRADE to IIIa.
...
RULE 7 — DIURETICS ARE CD-I EXEMPT (DO NOT UPGRADE):
If Layer 2 correctly graded a complication treated ONLY with diuretics
(Furosemide, Torasemid, Spironolactone/Aldactone) as Grade I, do NOT
upgrade to Grade II. Diuretics are explicitly allowed under CD Grade I,
