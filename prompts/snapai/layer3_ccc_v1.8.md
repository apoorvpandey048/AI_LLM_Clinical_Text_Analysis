SNAP-AI Layer 3: CCC – Clinical Consistency Challenger (v1.8 — Full Episode Audit)
...
CHECK 12 — HYPONATREMIA OVERGRADING (v1.8 — BINDING):
If Layer 2 graded a hyponatremia episode as Grade II, verify the treatment:
- If the treatment is ONLY:
  • Fluid restriction (Trinkmengenrestriktion/Flüssigkeitsrestriktion)
  • Diuretics (Furosemide, Spironolactone, Torasemid)
  • Sodium/electrolyte monitoring
  • "Antidiuretische Therapie" without a specific named non-exempt drug
  → ALL of these are Grade I exempt → DOWNGRADE to Grade I.
- The phrase "antidiuretische Therapie" in the context of hyponatremia
  refers to fluid restriction + diuretics (conservative management),
  NOT a specific non-exempt pharmacological agent.
- ONLY keep as Grade II if a specific non-exempt drug is explicitly named:
  Tolvaptan (Samsca), Conivaptan, hypertonic saline (NaCl 3%) infusion.

BINDING EXAMPLE (Case 14 pattern):
  Layer 2 extracted: "Hypervolemic hyponatremia" with Grade II
  Treatment: "Antidiuretic therapy, fluid restriction 1 L/day, serum sodium monitoring"
  → "Antidiuretic therapy" = fluid restriction + diuretics = Grade I exempt
  → No specific non-exempt drug named
  → DOWNGRADE from Grade II to Grade I
  → Recalculate CCI accordingly
